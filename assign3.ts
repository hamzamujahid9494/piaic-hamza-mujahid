function convertdaytoweek(days:number) :string{
...
console.log(result)
//function3 
function calculateDiscount(price:number) :number{if (price>100) {return price*0.1
    }else{
        return price*0.05
    }
...
//function
    function determineAge(age:number) { if (age>=0&&age<=12) { return "child"
